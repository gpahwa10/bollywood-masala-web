...
const MASALA_ON_LOCATION: Array<{
  id: number;
  title: string;
  category: string;
  thumbnail: string;
...
export default function MasalaOnLocation() {
  return (
...
type MasalaOnLocationCardProps = {
  title: string;
  category: string;
  thumbnail: string;
  videoCount?: number;
...
function MasalaOnLocationCard({
  title,
  category,
  thumbnail,
  videoCount,
  isSelected,
}: MasalaOnLocationCardProps) {
  return (
    <article
      className={`
