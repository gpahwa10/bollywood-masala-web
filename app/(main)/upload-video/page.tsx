        ...
        <div className='flex flex-col gap-3 min-w-0'>
            <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-2'>
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-sm sm:text-base text-[#666666] font-regular max-w-full'>Uploade videos will be reviewed before going live on Bollywoodmasala.</p>
                </div>
            </div>
            <div className='bg-white rounded-[8px] border border-[#19191926] p-5 my-4'>
                <form className='flex flex-col gap-1'>
                    ...
                    <div className='flex flex-col gap-2 my-8'>
                        <h3 className='text-lg sm:text-lg md:text-lg font-medium'>Upload Video</h3>
