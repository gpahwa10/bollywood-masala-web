...
const page = () => {
    return (
        <div className='flex flex-col gap-1'>
            <h1 className='text-2xl font-bold'>Reporter Details</h1>
            <h4 className='text-base text-[#666666] font-medium'>We're here to help you with any problems you may be having with our product.</h4>
            <div className='bg-white rounded-[8px] border border-[#19191926] p-5'>
                <form className='flex flex-col gap-1'>
                   ...
                   <div className='flex flex-row items-center gap-2'>
                        <input
                            type="checkbox"
                            className="w-4 h-4 rounded border border-[#19191926]"
                        />
                        <span className='text-lg font-medium'>I have read the <Link href="/terms-conditions"><span className='text-[#DF3234] underline cursor-pointer'>Terms & Conditions</span></Link> and promise to abide by them</span>
                    </div>
                    <button
                        type="button"
                        style={{
